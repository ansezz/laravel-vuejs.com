    ...
    methods: {
        ...
        */
        submitFile: function submitFile() {
            ...
            this.loading = true;
            axios.post('/nova-vendor/wp-importer/upload', formData, {
                headers: {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Wp Importer")]),
      _vm._v(" "),
      _c(
        "card",
        {
        ...
        [
          _c("h1", { staticClass: " text-4xl  font-light mb-6" }, [
            _vm._v(
              ...
              _c(
                ...
                [
                  _c("input", {
                    ...
                    attrs: { type: "file", "aria-label": "File xml" },
                    on: {
                  ...
                  _c(
                    ...
                    {
                      staticClass:
                        "flex-no-shrink bg-teal hover:bg-teal-dark border-teal hover:border-teal-dark text-sm border-4  py-1 px-2 rounded",
                      attrs: { type: "submit" }
                    },
                    [_vm._v("\n                    Importer\n                ")]
                  )
