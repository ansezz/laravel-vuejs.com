...
return [
    ...
    */
    ...
    'seo' => [
        'author' => 'LaravelVueJs',
        'description' => 'Laravel VueJs project docs',
        'keywords' => 'Laravel, VueJs, Docs, Laravel-VueJs',
        'og' => [
            'title' => 'Laravel & VueJs Docs',
            'type' => 'article',
            'url' => 'https://laravel-vuejs.com/docs',
            'image' => '',
            'description' => 'Laravel & VueJs Docs',
        ]
    ],
    ...
    */
    ...
    'repository' => [
        'provider' => 'github',
        'url' => 'https://github.com/ansezz/laravel-vuejs.com'
    ]
];
