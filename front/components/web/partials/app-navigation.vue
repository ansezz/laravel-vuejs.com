        ...
        <div class="navigation-header">
            <a @click.prevent="toggleNavigationVisibility" href="#" class="close-menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                    <path fill="#6936D3" fill-rule="evenodd" d="M16 5.209L14.791 4 10 8.791 5.209 4 4 5.209 8.791 10 4 14.791 5.209 16 10 11.209 14.791 16 16 14.791 11.209 10z"/>
                </svg>
                <span>Menu</span>
            </a>
        </div>
